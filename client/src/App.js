...
function App() {
  ...
  let Projects = [
    {
      ...
      projectInfo: [
        ...
        "consectetur adipiscing elit. Sed euismod mauris vel urna ultrices",
      ],
      techUsed: ["HTML", "Javascript"],
      reviews: 50,
      dateModified: new Date("2024-01-15"),
      projectType: "Web devlopment",
      collaboration: false,
      completed: true,
    },

    {
      ...
      image:
        "https://thumbs.dreamstime.com/z/bridge-over-mississippi-river-2483015.jpg?ct=jpeg",
      projectInfo: [
        "Lorem ipsum dolor sit amet",
        "consectetur adipiscing elit. Sed euismod mauris vel urna ultrices",
      ],
      techUsed: ["CSS", "Javascript"],
      reviews: 90,
      dateModified: new Date("2023-01-15"),
      projectType: "Game devlopment",
      collaboration: true,
      completed: false,
    },
  ...
  let Courses = [
    ...
    {
      id: 2,
      courseName: "Web dev full course",
      from: "coding Ninja",
      link: "www.google.com",
      rating: 5,
      online: true,
